...
Ministry/State : '.$row["problemDeptId"].' Category : '.$row["problemCategory"].' Total Submissions : 144
        ...
        <div id="i'.$row["problemId"].'" class="collapse" style="margin:-15px 0px 10px 20px;width:91.5%;border-style:solid;border-color:#dedede;border-width: 2px;">
...
Ministry/State : '.$row["mini"].' Sector : '.$row["sector"].' Category : '.$row["cate"].' Priority : '.$row["peri"].' Total Submissions : 144
        ...
        <div id="'.$row["id"].'" class="collapse" style="margin:-15px 0px 10px 20px;width:91.5%;border-style:solid;border-color:#dedede;border-width: 2px;"><div style="margin:10px">'
            .$row["pdesc"].
            '</div>';*/
        }
        }
